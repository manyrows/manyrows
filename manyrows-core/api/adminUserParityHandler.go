...
// POST /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/magic-link
...
// PUT /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/password
...
// PUT /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/email-verified
...
// GET /admin/workspace/{workspaceId}/products/{productId}/apps/{appId}/users/{userId}/check-permission?permission=slug
func (handler *RequestHandler) HandleAdminCheckUserPermission(w http.ResponseWriter, r *http.Request) {
	_, productID, appID, ok := handler.parseAppContext(w, r)
	if !ok {
		return
	}
	user, ok := handler.loadUserScopedToApp(w, r, appID)
	...
	_, perms, err := handler.resolveRolesAndPermissions(r.Context(), productID, user.ID, appID)
	if err != nil {
