...
func setupIPAllowlistRouter(t *testing.T) *chi.Mux {
	...
	wsRouter.Get("/products/{productId}/apps/{appId}/ipAllowlist", svc.Handler.HandleGetIPAllowlist)
	wsRouter.Post("/products/{productId}/apps/{appId}/ipAllowlist", svc.Handler.HandleCreateIPAllowlistEntry)
	wsRouter.Put("/products/{productId}/apps/{appId}/ipAllowlist/{id}", svc.Handler.HandleUpdateIPAllowlistEntry)
	wsRouter.Delete("/products/{productId}/apps/{appId}/ipAllowlist/{id}", svc.Handler.HandleDeleteIPAllowlistEntry)

	return r
}

func ipBasePath(wsID, productID, appID string) string {
	return "/admin/workspace/" + wsID + "/products/" + productID + "/apps/" + appID + "/ipAllowlist"
}
...
func TestGetIPAllowlist_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, ipBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String()), nil)
...
func TestCreateIPAllowlistEntry_SingleIP(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, ipBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String()), bytes.NewReader(bodyBytes))
...
func TestDeleteIPAllowlistEntry_Success(t *testing.T) {
	...
	base := ipBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String())
...
func TestUpdateIPAllowlistEntry_NotFound(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, ipBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String())+"/"+fakeID.String(), bytes.NewReader(bodyBytes))
	req.Header.Set("Content-Type", "application/json")
	testEnv.SetSessionCookie(t, req, claims)
