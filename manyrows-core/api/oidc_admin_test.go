...
func setupOIDCAdminRouter(t *testing.T) *chi.Mux {
	...
	wsRouter.Get("/products/{productId}/apps/{appId}/oidc-config", svc.Handler.HandleGetAppOIDCConfig)
	wsRouter.Put("/products/{productId}/apps/{appId}/oidc-config", svc.Handler.HandleUpdateAppOIDCConfig)
	return r
}
...
func createOIDCAppFixture(t *testing.T) (*core.Account, *core.Workspace, *core.Product, uuid.UUID, *core.Session, core.TokenClaims) {
	t.Helper()
...
func putOIDCConfig(t *testing.T, router *chi.Mux, ws *core.Workspace, project *core.Product, appID uuid.UUID, claims core.TokenClaims, body any) *httptest.ResponseRecorder {
	t.Helper()
	...
	req := httptest.NewRequest(http.MethodPut,
		"/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/oidc-config",
...
func TestAdminOIDCConfig_EnableAndGenerateSecret(t *testing.T) {
	...
	getReq := httptest.NewRequest(http.MethodGet,
		"/admin/workspace/"+ws.ID.String()+"/products/"+project.ID.String()+"/apps/"+appID.String()+"/oidc-config", nil)
