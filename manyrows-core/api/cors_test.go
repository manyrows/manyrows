...
func setupCORSRouter(t *testing.T) *chi.Mux {
	...
	wsRouter.Get("/products/{productId}/apps/{appId}/corsOrigins", svc.Handler.HandleGetCorsOrigins)
	wsRouter.Post("/products/{productId}/apps/{appId}/corsOrigins", svc.Handler.HandleCreateCorsOrigin)
	wsRouter.Delete("/products/{productId}/apps/{appId}/corsOrigins/{id}", svc.Handler.HandleDeleteCorsOrigin)

	return r
}

func corsBasePath(wsID, productID, appID string) string {
	return "/admin/workspace/" + wsID + "/products/" + productID + "/apps/" + appID + "/corsOrigins"
}
...
func TestGetCorsOrigins_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, corsBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String()), nil)
...
func TestCreateCorsOrigin_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, corsBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String()), bytes.NewReader(bodyBytes))
...
func TestDeleteCorsOrigin_Success(t *testing.T) {
	...
	base := corsBasePath(ws.ID.String(), app.ProductID.String(), app.ID.String())
