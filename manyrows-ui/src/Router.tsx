...
const ProductRouter = React.lazy(() => import("./product/ProductRouter.tsx"));
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="app" element={<App />}>
          ...
          <Route path="workspace/:workspaceId/products/:productId" element={<ProductRouter />} />
          <Route path="workspace/:workspaceId/products/:productId/apps/:appId" element={<ProductRouter />} />
          <Route path="workspace/:workspaceId/products/:productId/apps/:appId/:appPage" element={<ProductRouter />} />
          <Route path="workspace/:workspaceId/products/:productId/:projectPage" element={<ProductRouter />} />
